...
{$IFDEF VER170}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D2005
{$IFDEF VER185}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D2007
{$IFDEF VER210}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D2010
{$IFDEF VER220}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE
{$IFDEF VER230}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE2
{$IFDEF VER240}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE3
{$IFDEF VER260}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE5
{$IFDEF VER270}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE6
{$IFDEF VER280}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE7
{$IFDEF VER290}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D XE8
{$IFDEF VER300}{$DEFINE D9}{$DEFINE D8}{$DEFINE D7}{$DEFINE D6}{$DEFINE D5}{$DEFINE D4}{$DEFINE D3}{$DEFINE D2}{$ENDIF} // D 10
...
const
  NSUBEXP = 99; // max number of subexpression //###0.929
...
{$IFDEF MSWINDOWS}
uses
  Windows, Character; // CharUpper/Lower
{$ENDIF}
...
//  SetLength (Stack, StackSz); //###0.945
  ...
  // check if entire r.e. added
    if (ASubExprs.Count = 0)
      or ((PTR_INT(ASubExprs.Objects[0]) and $FFFF) <> 1)
      or (((PTR_INT(ASubExprs.Objects[0]) shr 16) and $FFFF) <> Len)
